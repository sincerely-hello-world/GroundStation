...
static const ::rosidl_typesupport_introspection_cpp::MessageMember T265Data_message_member_array[5] = {
  {
    "pos_x",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(uav_car_interfaces::msg::T265Data, tof_z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
