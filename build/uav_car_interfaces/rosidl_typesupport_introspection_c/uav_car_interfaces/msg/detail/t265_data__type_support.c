...
static rosidl_typesupport_introspection_c__MessageMember T265Data__rosidl_typesupport_introspection_c__T265Data_message_member_array[5] = {
  {
    "pos_x",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(uav_car_interfaces__msg__T265Data, tof_z),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
