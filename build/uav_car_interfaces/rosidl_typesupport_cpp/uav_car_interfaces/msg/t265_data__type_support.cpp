...
static const _T265Data_type_support_symbol_names_t _T265Data_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uav_car_interfaces, msg, T265Data)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, uav_car_interfaces, msg, T265Data)),
  }
};
...
{
  return &::uav_car_interfaces::msg::rosidl_typesupport_cpp::T265Data_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, uav_car_interfaces, msg, T265Data)() {
  return get_message_type_support_handle<uav_car_interfaces::msg::T265Data>();
}
